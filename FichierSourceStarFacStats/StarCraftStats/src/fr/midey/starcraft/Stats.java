...
import fr.midey.starcraft.Spell.Guérison;
import fr.midey.starcraft.Spell.Rage;
...
public class Stats extends JavaPlugin{
	...
	private HashMap<Player, Integer> cooldownRage = new HashMap<Player, Integer>();
	...
	private HashMap<Player, Integer> cooldownGuérison = new HashMap<Player, Integer>();
	...
	public void onEnable() {
		...
		pm.registerEvents(new Rage(this), this);
		//Spell jedi
		...
		pm.registerEvents(new Guérison(this), this);
	...
	public HashMap<Player, Integer> getCooldownGuérison() {
		return cooldownGuérison;
	}

	public HashMap<Player, Integer> getCooldownRage() {
		return cooldownRage;
	}
}
